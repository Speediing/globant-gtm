...
export const QUOTES: Quote[] = [
  ...
  },
  {
    ...
    date: "2026-08-17",
    quote:
      "ok, this is unexpected. @bot is making me consider downgrading my @claudeai and @OpenAI subscription.",
    source: "https://x.com/bdistel/status/2089422456125546892",
  },
  {
    name: "Kyle",
    handle: "@zeroxkyle",
    date: "2026-08-23",
    quote:
      "All those people spent thousands of dollars on Mac Minis and just half a year later Grok Bot abstracts it all away\nHonestly genius, pretty clear the direction agents are going to go towards now",
    source: "https://x.com/zeroxkyle/status/2091528869987938346",
  },
  {
    name: "Gergely Orosz",
    handle: "@GergelyOrosz",
